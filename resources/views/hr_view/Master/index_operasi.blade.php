                                            ...
                                            <table id="dt_basic_1" class="table table-hover table-bordered table-striped table-responsive">
                                                <thead> 
                                                    <tr>
                                                        ...
                                                        <th><center>Nama Jenis Operasi</center></th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><center>{{ $mp->jenis_operasi }}</center></td>
                                                        <td><center>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="exampleModalLabel">Tambah Jenis Operasi</h4>
            </div>
            <form id="formTambah" action="{{ url('master/jenis_operasi/tambah') }}" method="POST">
            @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label for="pangkat" class="col-form-label">Jenis Operasi</label>
  ...
  <div class="modal fade" id="edit-master" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Edit Master Jenis Operasi</h4>
            </div>
            <form id="formEdit" action="{{url('master/jenis_operasi/edit')}}" method="post">
            @csrf
                <div class="modal-body">
                    <input type="hidden" id="id_edit" name="id_edit">
                    <div class="form-group">
                        <label for="pangkat_edit" class="col-form-label">Jenis Operasi</label>
