                                            ...
                                            <table id="dt_basic_1" class="table table-hover table-bordered table-striped table-responsive">
                                                <thead> 
                                                    <tr>
                                                        ...
                                                        <th><center>Jenis Peralatan</center></th>
                                                        <th><center>Aksi</center></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php $no=1 ?>
                                                    @foreach($master_jenisperalatan as $mj)
                                                    <tr>
                                                        <td><center>{{ $no++ }}</center></td>
                                                        <td><center>{{ $mj->jenis_peralatan }}</center></td>
                                                        <td><center>
                                                            <button type="submit" class="btn btn-sm btn-primary" onclick="EditMaster(this)" data-item="{{json_encode($mj)}}"><i class="fa fa-edit"></i>&nbsp;Edit</button>
                                                            <button type="submit" class="btn btn-sm btn-danger" onclick="hapusMaster('{{$mj->id}}')"><i class="fa fa-trash"></i>&nbsp;Delete</button>
                                                        </center></td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
